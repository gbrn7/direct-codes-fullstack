...
<head>
  ...
  <!-- Link Css Main -->
  <link rel="stylesheet" href="{{ asset('directCodes/assets/Style/SignUpStyle/main.css') }}">
</head>
<body>
  <!-- Navbar Start -->
        ...
        <div class="col-lg-10 text-center text-lg-start d-flex">
          ...
          <div class="collapse navbar-collapse toggle">
            <ul class="navbar-nav ms-auto d-flex align-items-center gap-3 justify-content-center">
              ...
              <li class="nav-item"><a href="{{ route('member.login') }}"><div class="box-signup bg-light p-2">Sign In</div></a></li>
            </ul>
          </div>
      </div>
    </div>
              ...
              <div class="row-2 row justify-content-end">
                <div class="col-lg-12 text-lg-start input-wrapper">
                  <form action="{{ route('member.register.store') }}" method="POST">
                    @csrf
                    <div class="mb-2 col-lg-12  input-wrap">
                      <p class="mb-2">Name</p>
